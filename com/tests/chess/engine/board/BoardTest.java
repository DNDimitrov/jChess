...
public class BoardTest {
    ...
    public void initialBoard() {
      ...
      //  assertTrue(board.currentPlayer().getOpponent().isQueenSideCastleCapable());
        assertTrue(board.whitePlayer().getAlliance().equals(Alliance.WHITE));
        assertTrue(board.blackPlayer().getAlliance().equals(Alliance.BLACK));
    ...
    public void testFoolsMate() {
        ...
        final MoveTransition t2 = t1.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(
                board,BoardUtils.getCoordinateAtPosition("e7"),BoardUtils.getCoordinateAtPosition("e5")));
        assertTrue(t2.getMoveStatus().isDone());

        final MoveTransition t3 = t2.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(
