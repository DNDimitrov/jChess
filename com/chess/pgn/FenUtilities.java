...
public class FenUtilities {
    ...
    public static String createFenFromGame(final Board board) {
        return calculateBoardText(board) + " " +
                ...
                calculateEnPessantSquare(board) + " " + "0 1" ;
    }
    ...
    private static String calculateEnPessantSquare(final Board board) {
        final Pawn enPessatPawn = board.getEnPessantPawn();
        if(enPessatPawn != null) {
            return BoardUtils.getPositionAtCoordinate(enPessatPawn.getPiecePosition() + (8) * enPessatPawn.getAlliance().getOppositeDirection());
        }
        return "-";
    }
